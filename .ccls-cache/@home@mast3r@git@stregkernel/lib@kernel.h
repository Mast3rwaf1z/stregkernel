...
static int stregkernel_init(void) {
    quickbuy_major_number = register_chrdev(0, "fklub/" QUICKBUY_NAME, &quickbuy_operations);
    balance_major_number = register_chrdev(0, "fklub/" BALANCE_NAME, &quickbuy_operations);
